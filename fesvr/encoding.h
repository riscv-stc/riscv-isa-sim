...
#define MATCH_DMAPOLL 0x4400007b
#define MASK_DMAPOLL  0xffffffff
...
#define CSR_DMA_SHAPE_COL 0x430
#define CSR_DMA_SHAPE_ROW 0x431
#define CSR_DMA_STRIDE_DDR 0x432
...
DECLARE_INSN(dlxfer_d, MATCH_DLXFER_D, MASK_DLXFER_D)
DECLARE_INSN(dlxfer_u, MATCH_DLXFER_U, MASK_DLXFER_U)
DECLARE_INSN(icmov, MATCH_ICMOV, MASK_ICMOV)
DECLARE_INSN(sync, MATCH_SYNC, MASK_SYNC)
DECLARE_INSN(dmapoll, MATCH_DMAPOLL, MASK_DMAPOLL)
