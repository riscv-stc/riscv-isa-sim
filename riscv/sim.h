...
private:
  ...
  void interactive_mtrreg(const std::string& cmd, const std::vector<std::string>& args);
  void interactive_maccreg(const std::string& cmd, const std::vector<std::string>& args);
