  ...
  },
  {
    if (P.MU.mfp8 == MTYPE_FP8E4M3) {
      ...
      P.MU.acc_elt<uint16_t>(td_num + m, 0, i, j, mmax, des_nmax * amul, reg_rename, true) = f8e5m2_to_ui16(ts1, softfloat_roundingMode, true);
  ...
  },
  {
    if (P.MU.mfp16 == MTYPE_FP16) {
      ...
      P.MU.acc_elt<uint32_t>(td_num + m, 0, i, j, mmax, des_nmax * amul, reg_rename, true) = f16_to_ui32(ts1, softfloat_roundingMode, true);
  ...
  2, {require(P.MU.msew >= e8 && P.MU.msew <= 64);}, P.MU.msew)