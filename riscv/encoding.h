...
#define SYSDMA3_BASE       0xE3F00000
#define SYSDMA4_BASE       0xC3F00000
#define SYSDMA5_BASE       0xC5F00000
#define SYSDMA6_BASE       0xFBF00000
#define SYSDMA7_BASE       0xFDF00000

#define LLB_AXI0_BUFFER_START 0xD9000000    /* LLB_P0 (40MB) */
#define LLB_AXI1_BUFFER_START 0xE9000000    /* LLB_P1 (40MB) */
#define LLB_BUFFER_SIZE 0x2800000           /* 40M */
#define LLB_BANK_BUFFER_SIZE 0xa00000       /* NPC在 BANK内部共享 10MB 高速缓存 LLB */
...
#define MATCH_VEMGT_MM 0x5800007b
#define MASK_VEMGT_MM  0xfe00707f
#define MATCH_VEMEQ_MM 0x5800407b
#define MASK_VEMEQ_MM  0xfe00707f
#define MATCH_VEMLT_MM 0x5a00007b
#define MASK_VEMLT_MM  0xfe00707f
#define MATCH_VEMGT_MF 0x5800307b
#define MASK_VEMGT_MF  0xfe00707f
#define MATCH_VEMEQ_MF 0x5800707b
#define MASK_VEMEQ_MF  0xfe00707f
#define MATCH_VEMLT_MF 0x5a00307b
#define MASK_VEMLT_MF  0xfe00707f
...
#define MATCH_VEMASKMOV_MM 0x5c00007b
#define MASK_VEMASKMOV_MM  0xfe00707f
...
#define MATCH_MEARGMIN_M 0x7010107b
#define MASK_MEARGMIN_M  0xfff0707f
#define MATCH_MEARGMAX_M 0x7010507b
#define MASK_MEARGMAX_M  0xfff0707f
#define MATCH_MEDWCONV_MM 0x7400007b
#define MASK_MEDWCONV_MM  0xfe00707f
#define MATCH_VLE8PI_V 0x1100007
#define MASK_VLE8PI_V  0xfdf0707f
#define MATCH_VLE16PI_V 0x1105007
#define MASK_VLE16PI_V  0xfdf0707f
#define MATCH_VLE32PI_V 0x1106007
#define MASK_VLE32PI_V  0xfdf0707f
#define MATCH_VSE8PI_V 0x1100027
#define MASK_VSE8PI_V  0xfdf0707f
#define MATCH_VSE16PI_V 0x1105027
#define MASK_VSE16PI_V  0xfdf0707f
#define MATCH_VSE32PI_V 0x1106027
#define MASK_VSE32PI_V  0xfdf0707f
...
#define MATCH_EXEC_IT 0x8100
#define MASK_EXEC_IT  0xe183
#define MATCH_EX9_IT 0x8000
#define MASK_EX9_IT  0xe183
...
#define CSR_CONV_KERNEL_PARAMS3 0x41f
...
#define CAUSE_TCP_ACCESS_L1_CROSS_BOUNDARY 0x3b
#define CAUSE_TCP_ACCESS_LLB_CROSS_BOUNDARY 0x3c
#define CAUSE_TCP_INVALID_PARAM 0x3d
#define CAUSE_TCP_COREMAP_ZERO 0x3e
#define CAUSE_TCP_RW_ILLEGAL_PMP_CSR 0x3f
#define CAUSE_NCP_SYNC_TIMEOUT_TRIGGER 0x101
#endif
#ifdef DECLARE_INSN
...
DECLARE_INSN(vemgt_mm, MATCH_VEMGT_MM, MASK_VEMGT_MM)
DECLARE_INSN(vemeq_mm, MATCH_VEMEQ_MM, MASK_VEMEQ_MM)
DECLARE_INSN(vemlt_mm, MATCH_VEMLT_MM, MASK_VEMLT_MM)
DECLARE_INSN(vemgt_mf, MATCH_VEMGT_MF, MASK_VEMGT_MF)
DECLARE_INSN(vemeq_mf, MATCH_VEMEQ_MF, MASK_VEMEQ_MF)
DECLARE_INSN(vemlt_mf, MATCH_VEMLT_MF, MASK_VEMLT_MF)
...
DECLARE_INSN(vemaskmov_mm, MATCH_VEMASKMOV_MM, MASK_VEMASKMOV_MM)
...
DECLARE_INSN(meargmin_m, MATCH_MEARGMIN_M, MASK_MEARGMIN_M)
DECLARE_INSN(meargmax_m, MATCH_MEARGMAX_M, MASK_MEARGMAX_M)
...
DECLARE_INSN(exec_it, MATCH_EXEC_IT, MASK_EXEC_IT)
DECLARE_INSN(ex9_it, MATCH_EX9_IT, MASK_EX9_IT)
...
DECLARE_CSR(conv_kernel_params3, CSR_CONV_KERNEL_PARAMS3)
...
DECLARE_CSR(user3, CSR_USER3)
DECLARE_CSR(user4, CSR_USER4)
DECLARE_CSR(user5, CSR_USER5)
DECLARE_CSR(user6, CSR_USER6)
DECLARE_CSR(user7, CSR_USER7)
...
DECLARE_CAUSE("tcp access L1 cross boundary", CAUSE_TCP_ACCESS_L1_CROSS_BOUNDARY)
DECLARE_CAUSE("tcp access LLB cross boundary", CAUSE_TCP_ACCESS_LLB_CROSS_BOUNDARY)
DECLARE_CAUSE("tcp invalid param", CAUSE_TCP_INVALID_PARAM)
DECLARE_CAUSE("tcp coremap zero", CAUSE_TCP_COREMAP_ZERO)
DECLARE_CAUSE("tcp rw illegal pmp csr", CAUSE_TCP_RW_ILLEGAL_PMP_CSR)
DECLARE_CAUSE("ncp sync timeout trigger", CAUSE_NCP_SYNC_TIMEOUT_TRIGGER)
#endif
