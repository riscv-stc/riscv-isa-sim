...
#define MATCH_VEMV_F 0x2c00307b
#define MASK_VEMV_F  0xfff0707f
#define MATCH_ICXFER_P 0x3400007b
#define MASK_ICXFER_P  0xfe00707f
#define MATCH_ICXFER_M 0x3600007b
#define MASK_ICXFER_M  0xfe00707f
#define MATCH_LCXFER_D 0x3c00007b
#define MASK_LCXFER_D  0xfe00707f
#define MATCH_LCXFER_U 0x3e00007b
#define MASK_LCXFER_U  0xfe00707f
#define MATCH_LCXFER_U_M 0x3e00107b
#define MASK_LCXFER_U_M  0xfe00707f
#define MATCH_DLXFER_D 0x4000007b
#define MASK_DLXFER_D  0xfe00707f
#define MATCH_DLXFER_U 0x4200007b
...
#define MATCH_VETR_M 0x6000107b
#define MASK_VETR_M  0xfff0707f
#define MATCH_VEMMUL_MM 0x6400007b
#define MASK_VEMMUL_MM  0xfc00307f
...
#define CSR_NCP_BUSY 0x404
#define CSR_BC_SHAPE1 0x418
#define CSR_BC_SHAPE2 0x419
#define CSR_BC_STRIDE1 0x41a
#define CSR_BC_STRIDE2 0x41b
#define CSR_TCSR 0x406
#define CSR_TPARA0 0x407
#define CSR_TRBASE 0x408
#define CSR_TRSZ 0x409
#define CSR_TRMMC 0x40a
#define CSR_TRQHEAD 0x40b
#define CSR_TRQSIZE 0x40c
#define CSR_TMODE 0x40d
#define CSR_TMSGCLR 0x40e
#define CSR_TID 0x40f
...
DECLARE_INSN(vemv_f, MATCH_VEMV_F, MASK_VEMV_F)
DECLARE_INSN(icxfer_p, MATCH_ICXFER_P, MASK_ICXFER_P)
DECLARE_INSN(icxfer_m, MATCH_ICXFER_M, MASK_ICXFER_M)
DECLARE_INSN(lcxfer_d, MATCH_LCXFER_D, MASK_LCXFER_D)
DECLARE_INSN(lcxfer_u, MATCH_LCXFER_U, MASK_LCXFER_U)
DECLARE_INSN(lcxfer_u_m, MATCH_LCXFER_U_M, MASK_LCXFER_U_M)
...
DECLARE_INSN(vetr_m, MATCH_VETR_M, MASK_VETR_M)
DECLARE_INSN(vemmul_mm, MATCH_VEMMUL_MM, MASK_VEMMUL_MM)
#endif
#ifdef DECLARE_CSR
...
DECLARE_CSR(bc_shape1, CSR_BC_SHAPE1)
DECLARE_CSR(bc_shape2, CSR_BC_SHAPE2)
DECLARE_CSR(bc_stride1, CSR_BC_STRIDE1)
DECLARE_CSR(bc_stride2, CSR_BC_STRIDE2)
DECLARE_CSR(tcsr, CSR_TCSR)
DECLARE_CSR(tpara0, CSR_TPARA0)
...
DECLARE_CSR(tmode, CSR_TMODE)
DECLARE_CSR(tmsgclr, CSR_TMSGCLR)
