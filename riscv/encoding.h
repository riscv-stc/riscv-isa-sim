...
#define MATCH_VERSQRT 0x4030107b
#define MASK_VERSQRT  0xfff0707f
#define MATCH_VELN 0x4040107b
#define MASK_VELN  0xfff0707f
#define MATCH_VESIN 0x4050107b
#define MASK_VESIN  0xfff0707f
#define MATCH_VECOS 0x4060107b
#define MASK_VECOS  0xfff0707f
#define MATCH_VETANH 0x4070107b
#define MASK_VETANH  0xfff0707f
#define MATCH_VESIGMOID 0x4080107b
#define MASK_VESIGMOID  0xfff0707f
#define MATCH_VESINH 0x4090107b
#define MASK_VESINH  0xfff0707f
#define MATCH_VECOSH 0x40a0107b
#define MASK_VECOSH  0xfff0707f
...
#define MATCH_MEMUL_TS2_MM 0x6c00407b
#define MASK_MEMUL_TS2_MM  0xfe00707f
#define MATCH_MEMUL_TS3_MM 0x6e00007b
#define MASK_MEMUL_TS3_MM  0xfe00707f
...
#define MATCH_MEAVGPOOL 0x7600107b
#define MASK_MEAVGPOOL  0xfff0707f
#define MATCH_MEMAXPOOL 0x7600507b
#define MASK_MEMAXPOOL  0xfff0707f
...
#define MATCH_MEMUL_SP_MM 0x6400407b
#define MASK_MEMUL_SP_MM  0xfe00307f
#define MATCH_MEMUL_TS_MM 0x6C00007b
#define MASK_MEMUL_TS_MM  0xfe00307f
#define MATCH_MECONV_MM 0x6800007b
#define MASK_MECONV_MM  0xfe00707f
#define MATCH_MECONV_SP_MM 0x6800407b
#define MASK_MECONV_SP_MM  0xfe00707f
...
DECLARE_INSN(versqrt, MATCH_VERSQRT, MASK_VERSQRT)
DECLARE_INSN(veln, MATCH_VELN, MASK_VELN)
DECLARE_INSN(vesin, MATCH_VESIN, MASK_VESIN)
DECLARE_INSN(vecos, MATCH_VECOS, MASK_VECOS)
DECLARE_INSN(vetanh, MATCH_VETANH, MASK_VETANH)
DECLARE_INSN(vesigmoid, MATCH_VESIGMOID, MASK_VESIGMOID)
DECLARE_INSN(vesinh, MATCH_VESINH, MASK_VESINH)
DECLARE_INSN(vecosh, MATCH_VECOSH, MASK_VECOSH)
...
DECLARE_INSN(memul_ts2_mm, MATCH_MEMUL_TS2_MM, MASK_MEMUL_TS2_MM)
DECLARE_INSN(memul_ts3_mm, MATCH_MEMUL_TS3_MM, MASK_MEMUL_TS3_MM)
...
DECLARE_INSN(meavgpool, MATCH_MEAVGPOOL, MASK_MEAVGPOOL)
DECLARE_INSN(memaxpool, MATCH_MEMAXPOOL, MASK_MEMAXPOOL)
...
DECLARE_INSN(fshw, MATCH_FSHW, MASK_FSHW)
DECLARE_INSN(memul_mm, MATCH_MEMUL_MM, MASK_MEMUL_MM)
// DECLARE_INSN(memul_mm_sp, MATCH_MEMUL_SP_MM, MASK_MEMUL_SP_MM)
// DECLARE_INSN(memul_mm_ts, MATCH_MEMUL_TS_MM, MASK_MEMUL_TS_MM)
DECLARE_INSN(meconv_mm, MATCH_MECONV_MM, MASK_MECONV_MM)
// DECLARE_INSN(meconv_mm_sp, MATCH_MECONV_SP_MM, MASK_MECONV_SP_MM)
...
DECLARE_CSR(mte_stride, CSR_MTE_STRIDE)
