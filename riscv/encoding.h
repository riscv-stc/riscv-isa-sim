...
#define CSR_M_QUANT_COEFF 0x411
#define CSR_M_SPARSEIDX_BASE 0x412
#define CSR_M_SPARSEIDX_STRIDE 0x413
...
DECLARE_CSR(m_quant_coeff, CSR_M_QUANT_COEFF)
DECLARE_CSR(m_sparseidx_base, CSR_M_SPARSEIDX_BASE)
DECLARE_CSR(m_sparseidx_stride, CSR_M_SPARSEIDX_STRIDE)
