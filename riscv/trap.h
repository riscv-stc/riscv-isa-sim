...
DECLARE_TRAP(CAUSE_TCP_ICMOV_INVALID_CORE, dmae_invalid_param)
DECLARE_INST_TRAP(CAUSE_TCP_ACCESS_START, tcp_access_start)
DECLARE_MEM_TRAP(CAUSE_TCP_ACCESS_START, dmae_base_misaligned)
DECLARE_INST_TRAP(CAUSE_TCP_ACCESS_END_L1, tcp_access_end_l1)
DECLARE_INST_TRAP(CAUSE_TCP_ACCESS_END_L1, dmae_access_addr_fault)
DECLARE_INST_TRAP(CAUSE_TCP_ACCESS_END_LLB, tcp_access_end_llb)
DECLARE_TRAP(CAUSE_TCP_INVALID_PARAM, tcp_invalid_param)
DECLARE_TRAP(CAUSE_TCP_COREMAP_ZERO, tcp_coremap_zero)
DECLARE_TRAP(CAUSE_TCP_RW_ILLEGAL_PMP_CSR, tcp_rw_illegal_pmp_csr)
