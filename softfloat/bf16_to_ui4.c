...
uint_fast8_t bf16_to_ui4( bfloat16_t a, uint_fast8_t roundingMode, bool exact )
{
  union ui16_bf16 uA;
  uint_fast16_t uiA;
  bool sign;
  ...
  if ( 0xFF == exp )
  {
    ...
    return frac ? ui4_fromNaN 
                : sign ? ui4_fromNegOverflow : ui4_fromPosOverflow;
  }
  ...
  if( exp )
  {
    ...
    {
      softfloat_raiseFlags( softfloat_flag_invalid );
      return sign ? ui4_fromNegOverflow : ui4_fromPosOverflow;
    }
