...
// SEW = 16, VLEN = 256bit, VLMAX = VLEN / SEW
#define VLMAX    16
#define VL       10

#define MATRIX_ARRAY_LEN    32

static half vd_init = (half)44.0;
...
static void test_veadd(void)
{
    ...
    half rs1[MATRIX_ARRAY_LEN];
    half rs2[MATRIX_ARRAY_LEN];
    half rd[MATRIX_ARRAY_LEN];
    ...
    printf_half(rd, MATRIX_ARRAY_LEN);
...
static void test_veemacc(void)
{
    ...
    TEST_ADD_RD_S(rd_s);
    TEST_ADD_MATRIX(rd_v, rd, 0, 0, MATRIX_ARRAY_LEN); // enough
...
static void test_vecvt(void)
{
    class CustomInsns ci;
    struct ShapeStride ss;
    uint8_t rs1_u8[MATRIX_ARRAY_LEN];
    uint16_t rs1_u16[MATRIX_ARRAY_LEN];
    half rd[MATRIX_ARRAY_LEN];
    ...
    TEST_ADD_MATRIX(rd_m, rd, 0, 0, MATRIX_ARRAY_LEN);
...
static void test_vemul(void)
{
    ...
    TEST_ADD_MATRIX(rd_m, rd, 0, 0, MATRIX_ARRAY_LEN);
    TEST_ADD_MATRIX(rd_v, rd, 0, 0, MATRIX_ARRAY_LEN);
...
static void test_velkrelu(void)
{
    ...
    TEST_ADD_MATRIX(rs1_m, rs1, 4, 8, MATRIX_ARRAY_LEN);
    TEST_ADD_MATRIX(rs2_dim0_v, rs2, 4, 1, 4);
    TEST_ADD_MATRIX(rs2_dim1_v, rs2, 1, 5, 5);
    TEST_ADD_S(rs2_s, rs2[0]);
...
{
    class CustomInsns ci;
    uint16_t rs1[MATRIX_ARRAY_LEN];
    half base[MATRIX_ARRAY_LEN];
    half rd[MATRIX_ARRAY_LEN];
    int i;
    struct ShapeStride ss;
...
void test_vadd(void)
{
    ...
    TEST_ADD_MATRIX(vs1_v, vs1, 1, VLMAX, VLMAX);
    TEST_ADD_MATRIX(vs2_v, vs2, 1, VLMAX, VLMAX);
    TEST_ADD_S(rs1_s, vs1[0]);
    TEST_ADD_MATRIX(vd, vd, 1, VLMAX, VLMAX);

    PRINT_SUB_FUNC("vadd_vf vm = 0");
    MEMSET_VD4GOLDEN;
    add.vadd_vf(vs2, vs1[0], vd, 0, v0, VL);
    TEST_ADD_MATRIX(golden_vf_m, vd, 1, VLMAX, VLMAX);
    printf_half(vd, VLMAX);

    PRINT_SUB_FUNC("vadd_vf vm = 1");
    MEMSET_VD4GOLDEN;
    add.vadd_vf(vs2, vs1[0], vd, 1, v0, VL);
    TEST_ADD_MATRIX(golden_vf_nm, vd, 1, VLMAX, VLMAX);
    printf_half(vd, VLMAX);

    PRINT_SUB_FUNC("vadd_vv vm = 0");
    MEMSET_VD4GOLDEN;
    add.vadd_vv(vs2, vs1, vd, 0, v0, VL);
    TEST_ADD_MATRIX(golden_vv_m, vd, 1, VLMAX, VLMAX);
    printf_half(vd, VLMAX);

    PRINT_SUB_FUNC("vadd_vv vm = 1");
    MEMSET_VD4GOLDEN;
    add.vadd_vv(vs2, vs1, vd, 1, v0, VL);
    TEST_ADD_MATRIX(golden_vv_nm, vd, 1, VLMAX, VLMAX);
    printf_half(vd, VLMAX);
...
void test_vsub(void)
{
    ...
    MEMSET_VD4GOLDEN;
    sub.vsub_vf(vs2, vs1[0], vd, 0, v0, VL);
    TEST_ADD_MATRIX(golden_vf_m, vd, 1, VLMAX, VLMAX);
    printf_half(vd, VLMAX);

    PRINT_SUB_FUNC("vsub_vf vm = 1");
    MEMSET_VD4GOLDEN;
    sub.vsub_vf(vs2, vs1[0], vd, 1, v0, VL);
    TEST_ADD_MATRIX(golden_vf_nm, vd, 1, VLMAX, VLMAX);
    printf_half(vd, VLMAX);

    PRINT_SUB_FUNC("vsub_vv vm = 0");
    MEMSET_VD4GOLDEN;
    sub.vsub_vv(vs2, vs1, vd, 0, v0, VL);
    TEST_ADD_MATRIX(golden_vv_m, vd, 1, VLMAX, VLMAX);
    printf_half(vd, VLMAX);

    PRINT_SUB_FUNC("vsub_vv vm = 1");
    MEMSET_VD4GOLDEN;
    sub.vsub_vv(vs2, vs1, vd, 1, v0, VL);
    TEST_ADD_MATRIX(golden_vv_nm, vd, 1, VLMAX, VLMAX);
    printf_half(vd, VLMAX);
...
void test_vmul(void)
{
    ...
    MEMSET_VD4GOLDEN;
    mul.vmul_vf(vs2, vs1[0], vd, 0, v0, VL);
    TEST_ADD_MATRIX(golden_vf_m, vd, 1, VLMAX, VLMAX);
    printf_half(vd, VLMAX);

    PRINT_SUB_FUNC("vmul_vf vm = 1");
    MEMSET_VD4GOLDEN;
    mul.vmul_vf(vs2, vs1[0], vd, 1, v0, VL);
    TEST_ADD_MATRIX(golden_vf_nm, vd, 1, VLMAX, VLMAX);
    printf_half(vd, VLMAX);

    PRINT_SUB_FUNC("vmul_vv vm = 0");
    MEMSET_VD4GOLDEN;
    mul.vmul_vv(vs2, vs1, vd, 0, v0, VL);
    TEST_ADD_MATRIX(golden_vv_m, vd, 1, VLMAX, VLMAX);
    printf_half(vd, VLMAX);

    PRINT_SUB_FUNC("vmul_vv vm = 1");
    MEMSET_VD4GOLDEN;
    mul.vmul_vv(vs2, vs1, vd, 1, v0, VL);
    TEST_ADD_MATRIX(golden_vv_nm, vd, 1, VLMAX, VLMAX);
    printf_half(vd, VLMAX);
...
void test_vmerge(void)
{
    ...
    MEMSET_VD4GOLDEN;
    merge.vmerge_vf(vs2, vs1[0], vd, 0, v0, VL);
    TEST_ADD_MATRIX(golden_vf_m, vd, 1, VLMAX, VLMAX);
    printf_half(vd, VLMAX);

    PRINT_SUB_FUNC("vmerge_vf vm = 1");
    MEMSET_VD4GOLDEN;
    merge.vmerge_vf(vs2, vs1[0], vd, 1, v0, VL);
    TEST_ADD_MATRIX(golden_vf_nm, vd, 1, VLMAX, VLMAX);
    printf_half(vd, VLMAX);
...
void test_vsgnj(void)
{
    ...
    #define VSGNJ_TEST_VV(func, func_str)          \
        ...
        MEMSET_VD4GOLDEN;                          \
        sgnj.func(vs2, vs1, vd, 0, v0, VLMAX);     \
        printf_half(vd, VLMAX);                    \
                                                   \
        PRINT_SUB_FUNC(func_str" vm = 1");         \
        MEMSET_VD4GOLDEN;                          \
        sgnj.func(vs2, vs1, vd, 1, v0, VLMAX);     \
        printf_half(vd, VLMAX);

    #define VSGNJ_TEST_VF(func, func_str)              \
        PRINT_SUB_FUNC(func_str" vm = 0 rs < 0");      \
        MEMSET_VD4GOLDEN;                              \
        sgnj.func(vs2, (half)-5.0, vd, 0, v0, VLMAX);  \
        printf_half(vd, VLMAX);                        \
                                                       \
        PRINT_SUB_FUNC(func_str" vm = 0 rs > 0");      \
        MEMSET_VD4GOLDEN;                              \
        ...
        MEMSET_VD4GOLDEN;                              \
        sgnj.func(vs2, (half)-5.0, vd, 1, v0, VLMAX);  \
        printf_half(vd, VLMAX);                        \
                                                       \
        PRINT_SUB_FUNC(func_str" vm = 1 rs > 0");      \
        MEMSET_VD4GOLDEN;                              \
...
void test_vext(void)
{
    ...
    TEST_ADD_MATRIX_U16(vs2_v, vs2, 1, VLMAX, VLMAX);
    TEST_ADD_S_U16(rs1_s, rs1[0]);

    PRINT_SUB_FUNC("vext_x_v");
    ext.vext_x_v(vs2, rd, rs1[0], VL);
...
void test_vma(void)
{
    ...
    #define VMA_TEST_VF(func, func_str)                \
        PRINT_SUB_FUNC(func_str " vm = 0");            \
        MEMSET_VD4GOLDEN;                              \
        ma.func(vs2, vs1[0], vd, 0, v0, VL);           \
        TEST_ADD_MATRIX(golden_##func##_m, vd, 1, VLMAX, VLMAX); \
        printf_half(vd, VLMAX);                           \
                                                       \
        PRINT_SUB_FUNC(func_str" vm = 1");             \
        MEMSET_VD4GOLDEN;                              \
        ma.func(vs2, vs1[0], vd, 1, v0, VL);           \
        TEST_ADD_MATRIX(golden_##func##_nm, vd, 1, VLMAX, VLMAX);  \
        printf_half(vd, VLMAX);

    #define VMA_TEST_VV(func, func_str)                \
        PRINT_SUB_FUNC(func_str" vm = 0");             \
        MEMSET_VD4GOLDEN;                              \
        ma.func(vs2, vs1, vd, 0, v0, VL);              \
        TEST_ADD_MATRIX(golden_##func##_m, vd, 1, VLMAX, VLMAX);  \
        printf_half(vd, VLMAX);                           \
                                                       \
        PRINT_SUB_FUNC(func_str" vm = 1");             \
        MEMSET_VD4GOLDEN;                              \
        ma.func(vs2, vs1, vd, 1, v0, VL);              \
        TEST_ADD_MATRIX(golden_##func##_nm, vd, 1, VLMAX, VLMAX);  \
        printf_half(vd, VLMAX);
...
void test_vcompare(void)
{
    ...
    #define VCMP_TEST_VF(func, func_str)               \
        ...
        for (int i = 0; i < VLMAX; i++)                   \
            vd[i] = (uint16_t)3;                       \
        cmp.func(vs2, (half)15.0, vd, 0, v0, VLMAX);      \
        printf_uint16(vd, VLMAX);                         \
                                                       \
        PRINT_SUB_FUNC(func_str" vm = 1");             \
        for (int i = 0; i < VLMAX; i++)                   \
            vd[i] = (uint16_t)3;                       \
        cmp.func(vs2, (half)15.0, vd, 1, v0, VLMAX);      \
        printf_uint16(vd, VLMAX);
    ...
    #define VCMP_TEST_VV(func, func_str)               \
        ...
        for (int i = 0; i < VLMAX; i++)                   \
            vd[i] = (uint16_t)3;                       \
        cmp.func(vs2, vs1, vd, 0, v0, VLMAX);             \
        printf_uint16(vd, VLMAX);                         \
                                                       \
        PRINT_SUB_FUNC(func_str" vm = 1");             \
        for (int i = 0; i < VLMAX; i++)                   \
            vd[i] = (uint16_t)3;                       \
        cmp.func(vs2, vs1, vd, 1, v0, VLMAX);             \
        printf_uint16(vd, VLMAX);
